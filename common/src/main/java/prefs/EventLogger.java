...
public class EventLogger extends Logger {
    ...
    public EventLogger(String name, String resourceBundleName) {
        ...
        try {
            ...
            if (folder.exists() ? folder.isDirectory() : folder.mkdir()) {
                ...
                Handler file = new FileHandler(Prefs.logFolder + "\\log.log", true/*, 10 * 1024, 20, true*/);
    ...
    public void logError(Exception ex) { log(Level.SEVERE, ex.getMessage()); ex.printStackTrace(); }
